...
public class KondoriaAnimation {
    private static Image[] moveLeft = new Image[]{
            new Image(GameImages.KONDORIA_IMG + "_0.png"),
            new Image(GameImages.KONDORIA_IMG + "_5.png"),
            new Image(GameImages.KONDORIA_IMG + "_1.png")
    };
    private static Image[] moveRight = new Image[] {
            new Image(GameImages.KONDORIA_IMG + "_2.png"),
            new Image(GameImages.KONDORIA_IMG + "_5.png"),
            new Image(GameImages.KONDORIA_IMG + "_3.png")
    };

    private static Image[] dead = new Image[] {

            new Image(GameImages.KONDORIA_IMG + "_4.png"),
